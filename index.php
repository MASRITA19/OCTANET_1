...
<html lang="en">
    ...
    <body>
        ...
        <header class="header">
            <a href="#" class="logo">
                <img src="assets/images/logo5.png" class="img-logo" alt="KapeTann Logo" style="width: 150px; height: 120px;">
            </a>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Brewed Coffee Shop</h3>
                <p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    ...
                    <p>
                        At Brewed Coffee Shop, we are passionate about coffee and believe
    ...
    <div class="box-container">
        ...
        <section class="footer">
            <div class="footer-container">
                <div class="logo">
                    <img src="assets/images/logo5.png" class="img" style="width: 150px; height: 120px;"><br />
                    <i class="fas fa-envelope"></i>
                    <p>disha.mehta661@gmail.com</p><br />
